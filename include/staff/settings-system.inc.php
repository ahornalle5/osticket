...
$gmtime = Misc::gmtime();
?>
<h2><?php echo __('System Settings and Preferences');?> <small>— <span class="ltr">osTicket (<?php echo $cfg->getVersion()
        ...
        <tr>
            ...
            <td>
            	<?php if(!isset($config['helpdesk_width']))
					$config['helpdesk_width'] = '940px'; ?>
               <input type="text" name="helpdesk_width" value="<?php echo $config['helpdesk_width']; ?>">&nbsp;px (/ %)&nbsp;(<?php echo __('Default'); ?>&nbsp;940px)
        <tr>
            <th colspan="2">
            ...
            <td>
                <select name="max_file_size">
                    ...
                    while ($next <= $limit) {
                        ...
                        $selected = ($diff >= 0 && $next <= $config['max_file_size'])
                            ? 'selected="selected"' : ''; ?>
