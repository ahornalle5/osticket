        ...
        <div class="flush-right">
            ...
            <div id="action-dropdown-task-options"
                ...
                <ul>
                    ...
                    <li <?php if ($action['class']) echo sprintf("class='%s'", $action['class']); ?> >
                        <a class="no-pjax <?php echo ($action['label'] == __('Print')) ? '' : 'task-action'; ?>" <?php
                            if ($action['dialog'])
            ...
            <?php
                ...
                <span class="action-button <?php echo $action['class'] ?: ''; ?>">
                    <a class="<?php echo ($action['label'] == __('Print')) ? 'no-pjax' : 'task-action'; ?>"
                        <?php
                        if ($action['dialog'])
                            echo sprintf("data-dialog-config='%s'", $action['dialog']);
                        if ($action['redirect'])
        ...
        <tr>
            <td width="50%">
                <table border="0" cellspacing="" cellpadding="4" width="100%">
					...
					TS::displayTimeFieldOverview($task->getThreadId());
                    ?>
                </table>
            </td>
