...
class OsticketConfig extends Config {
    ...
    function getTimesheetVersion() {
		if($this->get('timesheet_version') != null)
			return $this->get('timesheet_version');
		elseif($this->get('timesheetInstalled') != null) // fallback for ts-v0.1
			return $this->get('timesheetInstalled');
		else
			return false;
    }
    ...
    function updateSystemSettings($vars, &$errors) {
		...
		if(is_numeric($vars['helpdesk_width']))
			$vars['helpdesk_width'] = $vars['helpdesk_width'].'px';
        ...
        return $this->updateAll(array(
            ...
            'helpdesk_width'=>$vars['helpdesk_width'],
